...
0
|| checktplrefresh('./template/default/forum/post_poll.htm', './template/default/common/upload.htm', 1650124651, '1', './data/template/1_1_forum_post_poll.tpl.php', './template/default', 'forum/post_poll')
;?>
...
<?php if($poll['isimage']) { ?>
<img src="<?php echo IMGDIR;?>/attachimg_2.png" class="cur1" onmouseover="showMenu({'menuid':'poll_img_preview_<?php echo $key;?>_menu','ctrlclass':'a','duration':2,'timeout':0,'pos':'34'});" onmouseout="hideMenu('poll_img_preview_<?php echo $key;?>_menu');" />
<?php } ?>
...
<span id="poll_img_preview_<?php echo $key;?>_menu" style="display: none">
<img src="<?php if($poll['imginfo'][$ppid]['small']) { ?><?php echo $poll['imginfo'][$ppid]['small'];?><?php } else { ?>static/image/common/nophoto.gif<?php } ?>" />
</span>
</span>
</p>
<?php } ?>
